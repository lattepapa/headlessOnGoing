...
export default function CartPage() {
    const { checkout, loading }: any = React.useContext(StoreContext)
            ...
            <div className={wrap}>
                {emptyCart ? (
                    <div className={emptyStateContainer}>
                        ...
                        <p>Looks like you haven’t found anything yet. We understand that sometimes it’s hard to chose — maybe this helps:</p>
