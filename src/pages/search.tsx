...
function SearchPage({
    ...
    const [filters, setFilters] = React.useState<any>(queryParams)
    const [sortKey, setSortKey] = React.useState<any>(queryParams.sortKey)
            ...
            <div className={main}>
                ...
                <section className={results} aria-busy={isFetching} aria-hidden={modalOpen}>
                    ...
                    <ul className={productListStyle}>
                        {!isFetching &&
                            productList.map(({ node }: any, index: any) => (
        ...
        <form onSubmit={(e) => e.preventDefault()} className={searchForm}>
            ...
            {term ? (
                <button
                    ...
                    onClick={() => {
                        setTerm('')
                        setFilters((filters: any) => ({ ...filters, term: '' }))
                    }}
 ...
 */
function Pagination({ previousPage, hasPreviousPage, nextPage, hasNextPage }: any) {
    return (
...
export default function SearchPageTemplate(props: any) {
    return (
        <SearchProvider>
            <SearchPage {...props} />
        </SearchProvider>
